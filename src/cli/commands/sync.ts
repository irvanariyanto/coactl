...
const TARGET_HINTS: Record<Target, string> = {
  ...
  "antigravity": ".antigravity/skills/, .antigravity/commands/, AGENTS.md",
  "gemini": ".gemini/skills/, GEMINI.md",
  "cline": ".clinerules/  (.md files)",
  "roo-code": ".roo/rules/  (.md files)",
  "continue": ".continue/rules/  (.md files)",
  "aider": "CONVENTIONS.md  (managed blocks)",
  "opencode": ".opencode/skills/, AGENTS.md",
  "zed": ".agents/skills/, AGENTS.md",
  "jetbrains": ".aiassistant/rules/  (.md files)",
