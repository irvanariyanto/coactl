<div align="center">
  ...
  <br><br>
  <p>
    <img src="https://img.shields.io/badge/version-0.4.3-bb8a45" alt="Version 0.4.3">
...
Moved the current version and update availability beside the coactl brand in the sticky top bar, so
users can always see release status without scrolling. The copyable update command now opens in a
compact, responsive popover.
